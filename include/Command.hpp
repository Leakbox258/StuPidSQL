...
struct CreateTableCommand : Command {
    ...
    CreateTableCommand(const std::string &table_name,
...
struct DropTableCommand : Command {
    std::string table_name;
    explicit DropTableCommand(const std::string &table_name)
...
struct SelectCommand : Command {
    ...
    SelectCommand(const std::string &table_name, const std::string &column,
...
struct UpdateCommand : Command {
    ...
    std::string value;
    std::string where_cond;
    UpdateCommand(const std::string &table_name, const std::string &column,
                  const std::string &value, const std::string &where_cond = "")
